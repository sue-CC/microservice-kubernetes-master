...
file_type_info = {
    "order_low_small_rest": ("low", "small"),
    "order_medium_small_rest": ("medium", "small"),
    "order_high_small_rest": ("high", "small"),
    "order_low_medium_rest": ("low", "medium"),
    "order_medium_medium_rest": ("medium", "medium"),
    "order_high_medium_rest": ("high", "medium"),
    "order_low_large_rest": ("low", "large"),
    "order_medium_large_rest": ("medium", "large"),
    "order_high_large_rest": ("high", "large"),
}

# Mapping for frequency and size
frequency_mapping = {"low": 0, "medium": 1, "high": 2}
size_mapping = {"small": 0, "medium": 1, "large": 2}
request_type_mapping = {"grpc": 1, "http": 0}  # Assuming 'grpc' as 1 and 'rest' as 0 for request type

# Input directory
input_dir = 'power_collection/row_data'

# Output directory
output_dir = 'power_collection/data'
...
for file_type, (frequency_str, size_str) in file_type_info.items():
    ...
    for i in range(1, 11):  # Assuming there are 10 files per type
