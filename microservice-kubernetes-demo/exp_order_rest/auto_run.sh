...
files=("order_low_small_rest" "order_medium_small_rest" "order_high_small_rest"
 "order_low_medium_rest" "order_medium_medium_rest" "order_high_medium_rest"
 "order_low_large_rest" "order_medium_large_rest" "order_high_large_rest")
