...
class GrpcUser(User):
    abstract = True
    hosts = {"catalog": "145.108.225.14:9095",
             "customer": "145.108.225.14:9096",
             "order": "145.108.225.14:9097"
             }
    ...
    def _get_stub_class(self, task_name):
        stub_classes = {
            "customer": customer_pb2_grpc.CustomerServiceStub,
            "catalog": catalog_pb2_grpc.CatalogServiceStub,
            "order": order_pb2_grpc.OrderServiceStub
        }
