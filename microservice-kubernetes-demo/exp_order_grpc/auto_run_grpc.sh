...
files=("order_low_small_grpc" "order_medium_small_grpc" "order_high_small_grpc"
 "order_low_medium_grpc" "order_medium_medium_grpc" "order_high_medium_grpc"
 "order_low_large_grpc" "order_medium_large_grpc" "order_high_large_grpc")
