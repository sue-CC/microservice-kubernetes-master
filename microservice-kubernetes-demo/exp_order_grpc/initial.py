...
file_type_info = {
    "order_low_small_grpc": ("low", "small"),
    "order_medium_small_grpc": ("medium", "small"),
    "order_high_small_grpc": ("high", "small"),
    "order_low_medium_grpc": ("low", "medium"),
    "order_medium_medium_grpc": ("medium", "medium"),
    "order_high_medium_grpc": ("high", "medium"),
    "order_low_large_grpc": ("low", "large"),
    "order_medium_large_grpc": ("medium", "large"),
    "order_high_large_grpc": ("high", "large"),
}
